# PRD: Subpoena and Information Request Response

**Use Case Rank:** 25 of 30  
**Folder:** `use-cases/25-subpoena-and-information-request-response/`  
...
**One-line description:** Analyzes request scope; suggests responsive sources and potential privilege issues; drafts response and objection templates; reduces cycle time and risk....
...
|-----------|--------------|--------|
| **Adoption** | 5 | High volume in regulated and litigation-heavy environments. |
| **Impact** | 7 | Faster identification of responsive documents and privilege. |
| **Complexity** | 7 | Requires matter and document context; privilege and proportionality. |
...
Analyzes request scope; suggests responsive sources and potential privilege issues; drafts response and objection templates; reduces cycle time and risk.
...
1. Request is received and ingested.
2. System parses scope, suggests sources, and flags privilege; draft response is generated.
3. Team reviews, collects documents, and finalizes response.
